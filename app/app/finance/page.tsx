import { DollarSign, Download, Filter, Search, TrendingDown, TrendingUp } from 'lucide-react'
  ...
  return (
    <div className="animate-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden flex flex-col">
        <div className="p-6 border-b border-slate-50 flex justify-between items-center bg-slate-50/30 gap-3 flex-wrap">
          <form method="get" className="flex items-center gap-2 flex-wrap">
            ...
            <div className="relative">
              ...
              <input name="q" defaultValue={q} type="text" placeholder="Filtrar lancamentos..." className="pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-xl text-xs outline-none" />
            </div>
          </form>
